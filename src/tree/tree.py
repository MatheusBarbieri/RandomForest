...
from information import attributes_gains
...
def _choose_best_attribute(data, attributes_index, attributes_kinds, class_index, m):
    ...
    aux = attributes_gains(data, attributes_index, attributes_kinds, attributes_list, class_index)
    ...
    return choice_name, choice_kind, choice_groups, choice_groups_index, all_infos[choice_index]
...
def _generate(data, attributes_index, attributes_kinds, class_index, m=None):
    if _is_class_unique(data, class_index):
        ...
        name, kind, grouped_data, index, gain = best_attribute
