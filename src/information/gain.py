...
def attributes_gains(data, attributes_index, attributes_kinds, attributes_list, class_index):
    ...
    attr_infos, all_groups, all_groups_index = info_attributes(data, attributes_index, attributes_kinds, attributes_list, class_index) # noqa
    gains = [df_info - info for info in attr_infos]
    return gains, all_groups, all_groups_index
